...
public class FragmentArtists extends FragmentBase {

    private static final String TAG = FragmentArtists.class.getSimpleName();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_artist_holder, container, false);
        RecyclerView listView = rootView.findViewById(R.id.artist_list);
    ...
    public void setMediaId(String mediaId) {
        ...
        args.putString(FragmentArtists.ARG_MEDIA_ID, mediaId);
        setArguments(args);
    }
