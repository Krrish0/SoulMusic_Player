...
public class FragmentAlbums extends FragmentBase {

    private static final String TAG = FragmentAlbums.class.getSimpleName();

    private static final String ARG_MEDIA_ID = "media_id";
    private static final String FRAGMENT_TAG = "albums_list_container";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_albums_holder, container, false);
        RecyclerView listView = rootView.findViewById(R.id.albums_list);
    ...
    public void setMediaId(String mediaId) {
        ...
        args.putString(FragmentAlbums.ARG_MEDIA_ID, mediaId);
        setArguments(args);
    }
