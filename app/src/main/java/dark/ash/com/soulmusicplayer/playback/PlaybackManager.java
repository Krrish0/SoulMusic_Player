...
public class PlaybackManager implements Playback.Callback {
    ...
    private static final String CUSTOM_ACTION_THUMBS_UP = "dark.ash.com.soulmusicplayer.THUMBS_UP";
    ...
    public PlaybackManager(PlaybackServiceCallback serviceCallback, Resources resources,
                           ...
                           Playback playback) {
        Log.e(TAG, "PlaybackManager Constructor is Called");
    ...
    public void updatePlaybackState(String error) {
        ...
        if (error != null) {
            ...
            stateBuilder.setErrorMessage(12, error);
    ...
    private void setCustomAction(PlaybackStateCompat.Builder stateBuilder) {
        ...
        Log.e()(TAG, "updatePlaybackState, setting Favorite custom action of music ",
    ...
    private class MediaSessionCallback extends MediaSessionCompat.Callback {
        ...
        public void onCustomAction(@NonNull String action, Bundle extras) {
            if (CUSTOM_ACTION_THUMBS_UP.equals(action)) {
                Log.e(TAG, "onCustomAction: favorite for current track");
                MediaSessionCompat.QueueItem currentMusic = mQueueManager.getCurrentMusic();
                if (currentMusic != null) {
                    String mediaId = currentMusic.getDescription().getMediaId();
                    if (mediaId != null) {
        ...
        public void onPlayFromSearch(final String query, final Bundle extras) {
            Log.e(TAG, "playFromSearch  query= " + query + " extras=" + extras);
